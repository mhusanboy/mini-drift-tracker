...
_STRINGS = {
    "ru": {
        ...
        "booking_line": "{date} {hour}:00–{end}:00 ({hours} ч, {people} чел.)",
        ...
        "booking_admin_line": "{hour}:00–{end}:00 — {people} чел. — {name} ({phone})",
        # day-offs
    ...
    "uz": {
        ...
        "booking_confirmed": "✅ Bron tasdiqlandi!\n{date} {hour}:00 dan {end}:00 gacha ({hours} soat).",
        ...
        "booking_line": "{date} {hour}:00–{end}:00 ({hours} soat, {people} kishi)",
        ...
        "booking_admin_line": "{hour}:00–{end}:00 — {people} kishi — {name} ({phone})",
        # day-offs

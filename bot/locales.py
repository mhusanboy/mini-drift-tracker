...
_STRINGS = {
    "ru": {
        ...
        "branch_admin_line": "{status} {name} ({open}–{close}) — {address}",
        "btn_add_branch": "➕ Добавить филиал",
        "btn_edit": "✏️ {name}",
        "btn_toggle_active": "🔀 переключить",
        "btn_delete": "🗑 Удалить",
        "btn_confirm_delete": "🗑 Да, удалить",
        "confirm_delete_branch": "Удалить филиал «{name}»?\nПрошлые брони сохранятся в статистике.",
    ...
    "uz": {
        ...
        "confirm_delete_branch": "«{name}» filialini o'chirasizmi?\nO'tgan bronlar statistikada saqlanadi.",

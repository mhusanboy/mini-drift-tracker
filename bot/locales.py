...
_STRINGS = {
    "ru": {
        ...
        # service settings
        "service_not_set": "🔧 Сервис ещё не настроен.",
        "service_line": "🔧 {name}\n{address}\nЧасы: {open}–{close}\nЛокация: {loc}",
        "btn_edit_service": "✏️ Настроить сервис",
        "ask_service_name": "Название сервиса:",
    ...
    "uz": {
        ...
        # service settings
        "service_not_set": "🔧 Xizmat hali sozlanmagan.",
        "service_line": "🔧 {name}\n{address}\nVaqt: {open}–{close}\nLokatsiya: {loc}",
        "btn_edit_service": "✏️ Xizmatni sozlash",
        "ask_service_name": "Xizmat nomi:",
